...
public class JimakuMixerBehaviour : PlayableBehaviour
{
    ...
    public override void ProcessFrame(Playable playable, FrameData info, object playerData)
    {
        ...
        for (int i = 0; i < inputCount; i++)
        {
            ...
            ScriptPlayable<JimakuBehaviour> inputPlayable = (ScriptPlayable<JimakuBehaviour>)playable.GetInput(i);
            JimakuBehaviour input = inputPlayable.GetBehaviour ();
